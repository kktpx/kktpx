...
AI-powered calorie and nutrition application built with a modern full-stack architecture.

**Stack:** `Next.js` `TypeScript` `React` `Prisma` `SQLite` `PostgreSQL` `Gemini API`
